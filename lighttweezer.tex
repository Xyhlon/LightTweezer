...
confirmed by the tutor. The active region for gold particles of a size of
\SI{50}{\nano\meter} was simulated and is visible in \autoref{fig:gold}. It is
visible that there happens to be a big peak in the violett/blue region and also
another one in the red area, which would in total result in the observed
colour. What is also visible in the graph is that mainly the dipole part of the
particle is present (orange in graph), which is a strong indicator for the
Rayleigh regime.
...
=======
	\caption[Simulated active region for gold particles]{Simulated active region for gold
		particles of a size of \SI{50}{\nano\meter} orange \dots dipole contribution of
		scattering \cite{ladutenkoOvidioprScattnlaySmall2017}.
>>>>>>> af177634e24afb72e90cc612b9ce515414302f42
	}\label{fig:gold}
\end{figure}
